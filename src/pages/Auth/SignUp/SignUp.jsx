...
function SignUp() {
  useEffect(() => {
    ...
    var emailLabel = document.querySelector('#signUpEmailLabel'),
      ...
      showPasswordConfirmCheck = document.querySelector('#showPasswordConfirmCheck'),
      showPasswordConfirmToggle = document.querySelector('#showPasswordConfirmToggle'),
    ...
    function initSignUpForm() {
      ...
      // handle events for passwordConfirm input
      passwordConfirm.addEventListener('focus', onPasswordFocus)
      passwordConfirm.addEventListener('blur', onPasswordBlur)
      //passwordLabel.addEventListener('click', onPasswordLabelClick);

      // handle events for password checkbox
      showPasswordCheck.addEventListener('change', function (e) {
        onPasswordToggleChange(e, password)
      })
      ...
      // handle events for password checkbox
      showPasswordConfirmCheck.addEventListener('change', function (e) {
        onPasswordToggleChange(e, passwordConfirm)
      })
      showPasswordConfirmCheck.addEventListener('focus', onPasswordToggleFocus)
      showPasswordConfirmCheck.addEventListener('blur', onPasswordToggleBlur)
      showPasswordConfirmCheck.addEventListener('click', onPasswordToggleClick)
      showPasswordConfirmToggle.addEventListener('mouseup', onPasswordToggleMouseUp)
      showPasswordConfirmToggle.addEventListener('mousedown', onPasswordToggleMouseDown)
    ...
    Validator.isConfirm = function (selector, getConfirmValue, message) {
      return {
        ...
        test: function (value) {
          var regex = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/
          return value === getConfirmValue() ? undefined : message || 'Xác nhận mật khẩu không trùng khớp'
        }
      }
    }
    ...
    Validator({
      ...
      rules: [
        Validator.isRequired('#signUpEmail'),
        Validator.isEmail('#signUpEmail'),
        Validator.isRequired('#signUpPassword'),
        Validator.isRequired('#signUpPasswordConfirm'),
        Validator.isConfirm('#signUpPasswordConfirm', function () {
          return document.querySelector('#signUpPassword').value
        })
      ],
    ...
    <div className="signup-container">
      <form id="form-signUp">
        <div className="svgContainer">
          <div>
            ...
            >
              ...
              <circle className='backgroundSGV' cx={100} cy={100} r={100} />
              <g className="body">
                <path
        ...
        <div className="inputGroup inputGroup1">
          ...
          <input type="email" id="signUpEmail" name="signUpEmail" maxLength={254} />
          <span className="form-message"></span>
        </div>
        <div className="inputGroup inputGroup2">
          <label htmlFor="signUpPassword" id="signUpPasswordLabel">
                        Password
          </label>
        ...
        <div className="inputGroup inputGroup2">
          <label htmlFor="signUpPasswordConfirm" id="signUpPasswordConfirmLabel">
                        Confirm Password
          </label>
          <input type="password" id="signUpPasswordConfirm" name="signUpPasswordConfirm" />
          <span className="form-message"></span>
          <label id="showPasswordConfirmToggle" htmlFor="showPasswordConfirmCheck">
                        Show
            <input id="showPasswordConfirmCheck" type="checkbox" />
            <div className="indicator" />
          </label>
        </div>
